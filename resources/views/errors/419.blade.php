...
<head>
  <meta charset="UTF-8" />
  <title>419 – Page Expired · ChainScholar</title>
...
<body class="min-h-screen bg-white flex items-center justify-center p-6">
  <main class="w-full max-w-2xl text-center">
    ...
    <h1 class="text-2xl md:text-3xl font-bold text-slate-900">419 — Page Expired</h1>
    <p class="mt-3 text-slate-600 text-sm md:text-base">
      Your session or form token expired. Refresh the page and try again.
    </p>
