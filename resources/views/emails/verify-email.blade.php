...
<body>
    <div class="container">
        ...
        <p>Thank you for registering with ChainScholar. Please click the button below to verify your email address.</p>
        ...
        <div class="footer">
            © {{ date('Y') }} ChainScholar. All rights reserved.<br><br>
            <small>
